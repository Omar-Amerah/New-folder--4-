...
const MIN_CLIENT_PROTOCOL = 6;
const MAX_CLIENT_PROTOCOL = 6;
const MIN_SERVER_PROTOCOL = 6;
const MAX_SERVER_PROTOCOL = 6;
const REQUIRED_CAPABILITIES = Object.freeze(['messagepack', 'entityDeltaSnapshotsV1']);
