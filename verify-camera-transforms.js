...
const { worldToScreen, screenToWorldPoint, clampCameraToWorld, zoomCameraAtScreenPoint, minimapToWorld, worldToMinimap, cameraViewportWorldBounds } = await import('./public/src/game/camera.js');
...
assert.equal(clampCameraToWorld({x:0,y:0,zoom:1},rect,world).x,450);
