...
// A reactor keeps both the coolingSupport source and the weapon powered under the
// corrected Balanced bands (Cooling & Support is the lowest band, below Weapons).
s=ship([mod("reactor",0,0),mod("fireControl",2,0),mod("railgun",3,0)], [[{x:2,y:0},{x:3,y:0}]], [[{x:0,y:0},{x:1,y:0},{x:2,y:0},{x:3,y:0}]]);
