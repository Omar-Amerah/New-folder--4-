...
s=ship([mod("reactor",0,0),mod("fireControl",1,0),mod("railgun",2,0)], [[{x:1,y:0},{x:2,y:0}]], [[{x:0,y:0},{x:1,y:0},{x:2,y:0}]]);
...
s=ship([mod("reactor",0,0),mod("fireControl",1,0),mod("railgun",2,0),mod("radiator",1,1)], [[{x:1,y:0},{x:2,y:0}]], [[{x:0,y:0},{x:1,y:0},{x:2,y:0}],[{x:1,y:0},{x:1,y:1}]]);
