...
function mixedSupportNetwork() { return make("mixed", "Reference C — Mixed support network", [["core",0,0],["reactor",1,0],["engine",3,0],["radiator",4,0],["fireControl",5,0],["sensorArray",6,0],["targetingComputer",7,0],["railgun",8,0],["blaster",9,0],["pointDefense",10,0],["auxGenerator",11,0],["auxGenerator",12,0],["auxGenerator",13,0]], lineEdges([5,6,7,8,9,10]), 1); }
