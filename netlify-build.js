...
const balanceSource = path.join(__dirname, "component-balance.json");
const balanceTarget = path.join(__dirname, "public", "component-balance.generated.json");
loadBalance(balanceSource);
fs.copyFileSync(balanceSource, balanceTarget);
fs.writeFileSync(path.join(__dirname, "public", "src", "generatedBalance.js"), `// Generated by netlify-build.js; do not edit.\nexport const GENERATED_BALANCE = ${fs.readFileSync(balanceSource, "utf8")};\n`, "utf8");
