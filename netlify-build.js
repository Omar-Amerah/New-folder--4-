...
// 4. Validate and copy the authoritative gameplay balance file for the static frontend.
generateBalanceArtifacts(__dirname);
console.log("Validated and copied component-balance.json to public/component-balance.generated.json");

// 5. Perform Netlify asset checks
const requiredFiles = [
  ...
  path.join(__dirname, "public", "src", "shared", "backupCoreRules.js"),
  path.join(__dirname, "public", "src", "shared", "weaponPresentationRules.js"),
  path.join(__dirname, "public", "src", "shared", "dataSupportRules.js"),
  path.join(__dirname, "public", "src", "shared", "protocolVersion.js"),
  path.join(__dirname, "public", "build-sha.js"),
  path.join(__dirname, "public", "component-balance.generated.json"),
  path.join(__dirname, "public", "src", "generatedBalance.js")
];
