...
// The part exists and is in the beam family with zero direct damage.
{
  ...
  assert.strictEqual(part.weapon.inductionHeatMaxPerSecond, 40);
  assert.strictEqual(part.weapon.inductionRampSeconds, 7);
  assert.strictEqual(part.weapon.inductionShieldMultiplier, 0.6);
  ...
  assert.strictEqual(part.activityHeat, 3);
  assert.strictEqual(part.heatPerShot, 0);
