...
function precisionBuild() { return make("precision", "Reference A — Precision build", [["core",0,0],["reactor",1,0],["engine",3,0],["radiator",4,0],["targetingComputer",5,0],["signalAmplifier",6,0],["railgun",7,0]], lineEdges([5,6,7]), 1); }
...
function mixedSupportNetwork() { return make("mixed", "Reference C — Mixed support network", [["core",0,0],["reactor",1,0],["engine",3,0],["radiator",4,0],["fireControl",5,0],["signalAmplifier",6,0],["targetingComputer",7,0],["railgun",8,0],["blaster",9,0],["pointDefense",10,0],["auxGenerator",11,0],["auxGenerator",12,0],["auxGenerator",13,0]], lineEdges([5,6,7,8,9,10]), 1); }
function redundantNetwork() { return make("redundant", "Reference D — Redundant network", [["core",0,0],["reactor",1,0],["engine",3,0],["radiator",4,0],["fireControl",5,0],["signalAmplifier",6,0],["frame",7,0],["missile",8,0],["blaster",9,0],["pointDefense",10,0],["frame",7,1],["frame",8,1],["frame",9,1],["auxGenerator",11,0],["auxGenerator",12,0]], [...lineEdges([5,6,7,8,9,10]), [[7,0],[7,1]], [[7,1],[8,1]], [[8,1],[9,1]], [[9,1],[9,0]]], 1); }
function isolatedNetworks() { return make("isolated", "Reference E — Isolated networks", [["core",0,0],["reactor",1,0],["engine",3,0],["radiator",4,0],["signalAmplifier",5,0],["railgun",6,0],["fireControl",7,0],["blaster",8,0],["auxGenerator",9,0],["auxGenerator",10,0],["auxGenerator",11,0]], [...lineEdges([5,6]), ...lineEdges([7,8])], 2); }
