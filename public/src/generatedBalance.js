...
export const GENERATED_BALANCE = {
  ...
  "drones": {
    ...
    "types": {
      "fighter": {
        ...
        "speed": 450,
        "turnRate": 5.6,
        "evasionLookaheadSeconds": 0.75,
        "evasionClearance": 75,
        "evasionStrength": 3.1,
        "evasionSpeedBoost": 0.35,
        "commandRange": 1650,
        "orbitDistance": 300,
        "weaponRange": 400,
        "damage": 15,
  ...
  "components": [
    ...
    },
    {
      ...
      "rotatable": true,
      "description": "Sustained shield-breaking beam that aims towards the enemy Core. It strikes the first obstruction and can carry part of its excess damage into one component directly behind a destroyed module.",
      "footprint": {
        "width": 1,
        "height": 2
      }
    ...
    },
    {
      ...
      "repair": 0,
      "rotatable": false,
      "description": "Launches and rebuilds a configurable squad of three Fighter, Defence, or Repair drones. Requires one completely exposed two-cell launch edge.",
      "footprint": {
        "width": 2,
        "height": 2
      }
    ...
    },
    {
      ...
      "utility": "range",
      "rangeBonus": 40,
      "description": "Support electronics that extend weapon range."
    },
    {
    ...
    },
    {
      ...
      "repair": 0,
      "utility": "capture",
      "description": "Objective module that increases relay capture pressure by 16%.",
      "captureBonus": 0.18
    },
    {
      "id": "signalAmplifier",
