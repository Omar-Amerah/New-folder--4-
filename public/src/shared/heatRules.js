(function initHeatRules(root, factory) {
  ...
  const CONDUCTIVITY = Object.freeze({ frame: 2.1, system: 0.72, armor: 0.48, compositeArmor: 0.28, heatSink: 1.4, radiator: 1.12, heatPipe: 3.2, destroyed: 0.18 });
  ...
  function profile(type, part) {
    ...
    const capacity = type === "heatSink" ? 340 : type === "radiator" ? 115 : type === "heatPipe" ? 70
      : type === "armor" ? 125 : type === "compositeArmor" ? 140 : 85;
    const cooling = type === "radiator" ? 14 : type === "heatSink" ? 1.5 : type === "heatPipe" ? 0.35
