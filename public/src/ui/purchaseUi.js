import { PART_DEFS, PART_DESCRIPTIONS, SHIP_ECONOMY, PART_STATS, LOCAL_DESIGN_KEY, LOCAL_SERVER_KEY, LOCAL_SAVED_DESIGNS_KEY, LOCAL_ACTIVE_ROOM_KEY, WORLD_FALLBACK, PURCHASE_PENDING_MS, PART_CATEGORIES, HIDDEN_PARTS } from "../constants.js";
import { dom, ctx, state, applyServerParts, hideMenuScreens, showMenuNotice, clearMenuNotice, openLobbyManagement } from "./dom.js";
import { joinRoom } from "./lobbyUi.js";
import { setEndGameActionState, returnToMainMenu } from "./endGameUi.js";
