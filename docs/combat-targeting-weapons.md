...
This document records current combat authority and does not rebalance weapons or
redesign combat AI. Broader full-stack browser combat scenarios and maximum-fleet
performance soak remain outside the focused verifier until additional
production-safe test hooks exist.
